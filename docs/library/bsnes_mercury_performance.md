# SNES / Super Famicom (bsnes-mercury Peformance)

## Contribute to this documentation

**In order to propose improvements to this document, [visit its corresponding source page on github](https://github.com/libretro/docs/tree/master/docs/library/bsnes_mercury_performance.md). Changes are proposed using "Pull Requests."**
...
### How to get and install the bsnes-mercury Peformance core:
...
- Browse through the list and select 'SNES / Super Famicom (bsnes-mercury Peformance)'.

<center> ![](images\Cores\higan\bsnes_mercury_performance.png) </center>
...
- If you are asked which core to select, choose 'SNES / Super Famicom (bsnes-mercury Peformance)'.
...
The bsnes-mercury Peformance core is licensed under

- [GPLv3](https://github.com/libretro/bsnes-mercury/blob/master/LICENSE)

## Extensions

Content that can be loaded by the bsnes-mercury Peformance core have the following file extensions:
...
RetroArch database(s) that are associated with the bsnes-mercury Peformance core:
...
!!! attention
	The bsnes-mercury Peformance core uses split ROMS for [special chip games](https://en.wikipedia.org/wiki/List_of_Super_NES_enhancement_chips#List_of_Super_NES_games_that_use_enhancement_chips).
...
RetroArch-level settings or features that the bsnes-mercury Peformance core respects.
...
The bsnes-mercury Peformance core's directory name is 'bsnes-mercury'

The bsnes-mercury Peformance core saves/loads to/from these directories.
...
- The bsnes-mercury Peformance core's internal FPS is 60 except for PAL games. PAL games are 50 fps.
- The bsnes-mercury Peformance core's internal sample rate is (Rate)
- The bsnes-mercury Peformance core's core provided aspect ratio is dependent on the ['Preferred aspect ratio' core option](https://docs.libretro.com/library/bsnes_mercury_performance#core-options).
...
The bsnes-mercury Perfomance core fully emulates all SNES games that have ever been officially released. 

## External Links

- [Libretro bsnes-mercury Performance Core info file](https://github.com/libretro/libretro-super/blob/master/dist/info/bsnes_mercury_accuracy_libretro.info)
