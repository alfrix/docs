...
**In order to propose improvements to this document, [visit its corresponding source page on github](https://github.com/libretro/docs/tree/master/docs/library/snes9x_2005.md). Changes are proposed using "Pull Requests."**
...
### How to get and install the Snes9x 2005 core:
...
- Browse through the list and select 'SNES / Super Famicom (Snes9x 2005)'.

<center> ![](images\Cores\snes9x\snes9x_2005.png) </center>
...
RetroArch-level settings or features that the Snes9x 2005 core respects.
...
The Snes9x 2005 core's directory name is 'Snes9x 2005'
...
- The Snes9x 2005 core's internal FPS is (FPS)
- The Snes9x 2005 core's internal sample rate is (Rate)
...
- [Libretro Snes9x 2005 Core info file](https://github.com/libretro/snes9x2005)
