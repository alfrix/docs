...
- [PlayStation (Beetle PSX HW)](https://doc.libretro.com/library/beetle_psx_hw/)
...
The Beetle PSX core supports the following controller setting(s), bolded controller settings are the default for the specified user(s):
...
| Beetle PSX  | RetroPad                                                       | PlayStation Controller                                       | DualShock                                                      | Analog Controller                                              | Analog Joystick                                                | neGcon                          |
|----------------|----------------------------------------------------------------|--------------------------------------------------------------|----------------------------------------------------------------|----------------------------------------------------------------|----------------------------------------------------------------|---------------------------------|
...
† These inputs can be modified with the ['Gun Trigger' core option](https://buildbot.libretro.com/docs/library/beetle_psx/#core-options).
